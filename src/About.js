      ...
      <Box marginTop={10}>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Box
              sx={{
                backgroundImage: `URL("./img/medical-563427_1920.jpg")`,
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardMedia
                component="img"
                height="194"
                image="./img/thermometer-1539191_1920.jpg"
                alt="Paella dish"
              />
              <CardContent>
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ maxWidth: 345 }}>
              <CardHeader
                ...
                title="Covid-Test"
                subheader="Book Slots"
              />
              <CardMedia
                component="img"
                height="194"
                image="./img/test-tube-5065426_1920.jpg"
                alt="Paella dish"
              />
              <CardContent>
                <Typography variant="body2" color="text.secondary">
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardMedia
                component="img"
                height="194"
                image="./img/analysis-2030266_1920.jpg"
                alt="Paella dish"
              />
              <CardContent>
                <Typography variant="body2" color="text.secondary">
